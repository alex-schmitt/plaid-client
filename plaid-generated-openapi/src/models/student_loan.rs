...
pub struct StudentLoan {
    ...
    #[serde(
        rename = "last_statement_issue_date",
        deserialize_with = "Option::deserialize"
    )]
    ...
    #[serde(
        rename = "payment_reference_number",
        deserialize_with = "Option::deserialize"
    )]
