...
pub struct LinkTokenCreateRequest {
    ...
    #[serde(
        rename = "additional_consented_products",
    ...
    #[serde(
        rename = "identity_verification",
        skip_serializing_if = "Option::is_none"
    )]
    pub identity_verification:
        Option<Box<crate::models::LinkTokenCreateRequestIdentityVerification>>,
