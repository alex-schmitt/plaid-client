...
impl CreditBankEmploymentWarning {
    ...
    pub fn new(
        warning_type: crate::models::CreditBankEmploymentWarningType,
        warning_code: crate::models::CreditBankIncomeWarningCode,
        cause: crate::models::CreditBankIncomeCause,
