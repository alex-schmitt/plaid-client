...
pub struct Transfer {
    ...
    #[serde(
        rename = "unauthorized_return_window",
        deserialize_with = "Option::deserialize"
    )]
    ...
    #[serde(
        rename = "expected_settlement_date",
        deserialize_with = "Option::deserialize"
    )]
...
impl Transfer {
    ...
    pub fn new(
        ...
        standard_return_window: Option<String>,
        unauthorized_return_window: Option<String>,
        expected_settlement_date: Option<String>,
        originator_client_id: Option<String>,
        refunds: Vec<crate::models::TransferRefund>,
        recurring_transfer_id: Option<String>,
    ) -> Transfer {
        Transfer {
            id,
            ach_class: None,
