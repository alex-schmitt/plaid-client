...
impl RiskCheckDevice {
    ...
    pub fn new(
        ip_proxy_type: Option<crate::models::ProxyType>,
        ip_spam_list_count: Option<i32>,
        ip_timezone_offset: Option<String>,
    ) -> RiskCheckDevice {
        RiskCheckDevice {
            ip_proxy_type,
            ip_spam_list_count,
