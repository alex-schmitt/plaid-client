...
pub struct TaxpayerIdentifier {
    ...
    #[serde(
        rename = "TaxpayerIdentifierValue",
        deserialize_with = "Option::deserialize"
    )]
...
impl TaxpayerIdentifier {
    ...
    pub fn new(
        taxpayer_identifier_type: Option<crate::models::TaxpayerIdentifierType>,
        taxpayer_identifier_value: Option<String>,
    ) -> TaxpayerIdentifier {
        TaxpayerIdentifier {
