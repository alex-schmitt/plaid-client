...
impl KycCheckDetails {
    ...
    pub fn new(
        status: String,
        address: crate::models::KycCheckAddressSummary,
        name: crate::models::KycCheckNameSummary,
        date_of_birth: crate::models::KycCheckDateOfBirthSummary,
        id_number: crate::models::KycCheckIdNumberSummary,
        phone_number: crate::models::KycCheckPhoneSummary,
    ) -> KycCheckDetails {
        KycCheckDetails {
            status,
            address,
