...
pub struct PaymentInitiationPayment {
    ...
    pub schedule: Option<Option<Box<crate::models::ExternalPaymentScheduleGet>>>,
    #[serde(
        rename = "refund_details",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub refund_details: Option<Option<Box<crate::models::ExternalPaymentRefundDetails>>>,
    ...
    pub amount_refunded: Option<Box<crate::models::PaymentAmountRefunded>>,
    ...
    #[serde(
        rename = "adjusted_scheme",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub adjusted_scheme: Option<Option<crate::models::PaymentScheme>>,
