...
impl ServiceProductFulfillmentDetail {
    ...
    pub fn new(
        vendor_order_identifier: Option<String>,
        service_product_fulfillment_identifier: crate::models::ServiceProductFulfillmentIdentifier,
