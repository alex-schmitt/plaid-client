...
impl DocumentAnalysis {
    ...
    pub fn new(
        authenticity: crate::models::DocumentAuthenticityMatchCode,
        image_quality: crate::models::ImageQuality,
        extracted_data: Option<crate::models::PhysicalDocumentExtractedDataAnalysis>,
    ) -> DocumentAnalysis {
        DocumentAnalysis {
            authenticity,
            image_quality,
