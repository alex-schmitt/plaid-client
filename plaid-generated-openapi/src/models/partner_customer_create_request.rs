...
pub struct PartnerCustomerCreateRequest {
    ...
    #[serde(
        rename = "create_link_customization",
    ...
    #[serde(
        rename = "assets_under_management",
        skip_serializing_if = "Option::is_none"
    )]
...
impl PartnerCustomerCreateRequest {
    ...
    pub fn new(
        ...
        address: crate::models::PartnerEndCustomerAddress,
        is_bank_addendum_completed: bool,
