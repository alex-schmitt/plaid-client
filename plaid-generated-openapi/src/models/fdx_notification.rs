...
pub struct FdxNotification {
    ...
    pub publisher: Box<crate::models::FdxParty>,
...
impl FdxNotification {
    ...
    pub fn new(
        ...
        r#type: crate::models::FdxNotificationType,
        sent_on: String,
        category: crate::models::FdxNotificationCategory,
        publisher: crate::models::FdxParty,
        notification_payload: crate::models::FdxNotificationPayload,
    ) -> FdxNotification {
        FdxNotification {
            notification_id,
            r#type,
