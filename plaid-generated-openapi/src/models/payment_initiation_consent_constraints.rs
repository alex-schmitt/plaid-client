...
pub struct PaymentInitiationConsentConstraints {
    #[serde(
        rename = "valid_date_time",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub valid_date_time: Option<Option<crate::models::PaymentConsentValidDateTime>>,
...
impl PaymentInitiationConsentConstraints {
    ...
    pub fn new(
        max_payment_amount: crate::models::PaymentConsentMaxPaymentAmount,
        periodic_amounts: Vec<crate::models::PaymentConsentPeriodicAmount>,
