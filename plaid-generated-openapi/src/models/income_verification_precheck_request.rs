...
pub struct IncomeVerificationPrecheckRequest {
    ...
    pub user: Option<Option<Box<crate::models::IncomeVerificationPrecheckUser>>>,
    #[serde(
        rename = "employer",
        default,
        with = "::serde_with::rust::double_option",
    ...
    #[serde(
        rename = "payroll_institution",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub payroll_institution:
        Option<Option<Box<crate::models::IncomeVerificationPrecheckPayrollInstitution>>>,
    ...
    #[serde(
        rename = "us_military_info",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub us_military_info:
        Option<Option<Box<crate::models::IncomeVerificationPrecheckMilitaryInfo>>>,
}
