...
impl SingleDocumentRiskSignal {
    ...
    pub fn new(
        document_reference: crate::models::RiskSignalDocumentReference,
        risk_signals: Vec<crate::models::DocumentRiskSignal>,
        risk_summary: crate::models::DocumentRiskSummary,
